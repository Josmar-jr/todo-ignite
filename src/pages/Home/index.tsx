...
export function Home() {
  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <main>
        <form onSubmit={createNewTask} className={styles.searchWrapper}>
          <input
            type="text"
        ...
        <div className={styles.todoContainer}>
          <header>
            <div>
              ...
              <span className={styles.tag}>{totalTasks}</span>
            </div>
            <div>
              <span>Concluídas</span>
              <span className={styles.tag}>{totalTasksCompleted} de {totalTasks}</span>
            </div>
          </header>
